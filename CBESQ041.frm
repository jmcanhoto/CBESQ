...
Begin VB.Form frmCAIFAlterarRecibos 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "CAIF - Gestao de Recibos de Utentes"
   ClientHeight    =   6180
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7140
   ...
   End
End
Attribute VB_Name = "frmCAIFAlterarRecibos"
...
Private Function tAbreBD()
    ...
    Set mWSAlteraRecibos = DBEngine.CreateWorkspace("CAIF Alteracoes", gUtilizador.Nome, gUtilizador.Password)
...
On Error GoTo TrataErro
        ...
        Set qryAlteraRecibo = mBDAlteraRecibos.QueryDefs("CAIF RECIBOS Altera Recibo")
...
Private Sub CarregaGridAlteracoes(ByRef Grid As SSDBGrid)
    ...
    With Grid
        ...
        cSql = "SELECT * FROM RECIBOS_IDOSOS WHERE NUM_UTENTE=" & _
