...
Begin VB.Form frmCAIFRendimentoPercapitaMapa 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "CAIF - Rendimento Percapita (Mapa)"
   ClientHeight    =   4725
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5925
   ...
   End
End
Attribute VB_Name = "frmCAIFRendimentoPercapitaMapa"
...
Private Function tAbreBD()
    ...
    Set mWSRendPercapitaMapa = DBEngine.CreateWorkspace("CAIFRendPercapitaMapa", gUtilizador.Nome, gUtilizador.Password)
...
TrataErro:
    tRetorno = False
    Call ErrosGerais("CAIF - Rendimento Percapita (Mapa)-Abrir BD", Err.Number, Err.Description)
    Resume SaiDaFuncao
...
On Error GoTo TrataErro
    ...
    cSql = "DELETE * FROM LISTA_RENDIMENTO_PERCAPITA_MAPA_IDOSOS;"
    ' apaga o registo em Temp32
    mBDRendPercapitaMapaTemp.Execute cSql, dbFailOnError
    
    ' carrega a variavela com o Sql
    cSql = "INSERT INTO LISTA_RENDIMENTO_PERCAPITA_MAPA_IDOSOS (NUM_UTENTE,COD_INST,COD_SALA,NOME," & _
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCAIFRendimentoPercapitaMapa = Nothing
End Sub
