...
Begin VB.Form frmCAIFTabelaAlteracoes 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "CAIF - Tabela de Alterações"
   ClientHeight    =   4125
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7095
   ...
   End
End
Attribute VB_Name = "frmCAIFTabelaAlteracoes"
...
Private Function tAbreBD()
    ...
    Set mWSTabelaAlteracoes = DBEngine.CreateWorkspace("CAIFAlteracoes", gUtilizador.Nome, gUtilizador.Password)
...
TrataErro:
    tRetorno = False
    Call ErrosGerais("CAIF - Tabela de Alterações Mensais-Abrir BD", Err.Number, Err.Description)
    Resume SaiDaFuncao
...
On Error GoTo TrataErro
    ...
    Set qryTABALTERACOES = mBDTabelaAlteracoes.QueryDefs("CAIF TABALTERACOES Altera")
...
Private Sub CarregaGridTabAlteracoes(ByRef Grid As SSDBGrid)
    ...
    With Grid
        ...
        cSql = "SELECT DESCRICAO1,DESCRICAO2,DESCRICAO3,DESCRICAO4,DESCRICAO5," & _
            "VALOR1,VALOR2,VALOR3,VALOR4,VALOR5 FROM TABALTERACOES_IDOSOS WHERE COD_MES='" & _
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCAIFTabelaAlteracoes = Nothing
End Sub
