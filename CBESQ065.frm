...
Begin VB.Form frmCriarRecibo 
   ...
   End
End
Attribute VB_Name = "frmCriarRecibo"
...
Private Function tAbreBD()
    ...
    Set mWSCriarRecibo = DBEngine.CreateWorkspace("Criar Recibo", gUtilizador.Nome, gUtilizador.Password)
...
TrataErro:
    tRetorno = False
    Call ErrosGerais("Criar Recibo-Abrir BD", Err.Number, Err.Description)
    Resume SaiDaFuncao
...
On Error GoTo TrataErro
        ...
        Set qryAlteraRecibo = mBDCriarRecibo.QueryDefs("RECIBOS Criar Recibo")
        ...
        qryAlteraRecibo.Parameters("MENSALIDADE_PCT") = sgrdAlteracoes.Columns(1).Value
...
Private Sub CarregaGridAlteracoes(ByRef Grid As SSDBGrid)
    ...
    With Grid
        ...
        cSql = "SELECT * FROM UTENTES WHERE NUM_UTENTE=" & _
        ...
        If Not (recCRIAR.EOF And recCRIAR.BOF) Then
            ...
            .AddItem "Refeições (Almoço)" & vbTab & 0
            .AddItem "Multa por Atraso" & vbTab & 0
            .AddItem "Seguro" & vbTab & 0
            .AddItem "Outras" & vbTab & 0
            .AddItem "Mensalidade" & vbTab & recCRIAR!MENSALIDADE_BASE
            .AddItem "1/10 ou 1/11" & vbTab & recCRIAR!MENSALIDADE
'            .AddItem "Total do Recibo" & vbTab & recCRIAR!TOTAL_MENSALIDADE
        End If
        recCRIAR.Close
