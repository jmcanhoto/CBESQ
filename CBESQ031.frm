...
Begin VB.Form frmRendimentoPercapita 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Rendimento Percapita (Ficha)"
   ClientHeight    =   4725
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5925
   ...
   End
End
Attribute VB_Name = "frmRendimentoPercapita"
...
Private Function tAbreBD()
    ...
    Set mWSRendPercapita = DBEngine.CreateWorkspace("RendPercapita", gUtilizador.Nome, gUtilizador.Password)
...
On Error GoTo TrataErro
    ...
    cSql = "DELETE * FROM LISTA_RENDIMENTO_PERCAPITA;"
    ' apaga o registo em Temp32
    mBDRendPercapitaTemp.Execute cSql, dbFailOnError
    
    ' carrega a variavela com o Sql
    cSql = "INSERT INTO LISTA_RENDIMENTO_PERCAPITA (NUM_UTENTE,COD_INST,COD_SALA,NOME,AGREGADO," & _
                                                    ...
                                                    "D_SC_1,D_T_1,D_O_DESC,D_O_1,D_SC_2,D_T_2,D_O_2,ESCALAO,PCT,DATA_CALCULO) IN '" & cBDComNomeUtilizador & "' " & _
        ...
        "UTENTES.D_SC_1,UTENTES.D_T_1,UTENTES.D_O_DESC,UTENTES.D_O_1,UTENTES.D_SC_2,UTENTES.D_T_2,UTENTES.D_O_2,UTENTES.PROX_ESCALAO,UTENTES.PROX_PCT,UTENTES.DATA_CALCULO FROM UTENTES WHERE ISNULL(DATA_SAIDA)"
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmRendimentoPercapita = Nothing
End Sub
